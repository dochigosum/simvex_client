...
function CADViewer({ objects, selectedObjectId, currentTool, onSelectObject, onUpdateObject, onSave0, onSave100, onDeselectTool }) {
  ...
  return (
    <div className="cad-viewer">
      ...
      <div className="save-buttons">
        ...
        <button className="help-btn" title="도움말">
          ?
        </button>
      </div>
